...
const source$T = `
<section class="text-gray-600 body-font relative pt-12">
  <div class="container px-5 py-24 mx-auto">
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="lg:w-2/3 mx-auto">
      <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4">
        <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 inset-0" src="https://dummyimage.com/820x340">
      ...
      <div class="flex flex-wrap -mx-2">
        <div class="px-2 w-1/2">
          <div class="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
            <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 inset-0" src="https://dummyimage.com/542x460">
            <div class="text-center relative z-10 w-full">
        ...
        <div class="px-2 w-1/2">
          <div class="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
            <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 inset-0" src="https://dummyimage.com/542x420">
            <div class="text-center relative z-10 w-full">
              <h2 class="text-xl text-gray-900 font-medium title-font mb-2">Shooting Stars</h2>
              <p class="leading-relaxed">Skateboard +1 mustache fixie paleo lumbersexual.</p>
              <a class="mt-3 text-indigo-500 inline-flex items-center">Learn More
...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 ml-auto mr-auto object-cover object-center rounded" alt="hero" src="https://dummyimage.com/720x600">
...
const components = {
  ...
  Blog4: Component$X,
  Blog5: Component$W,
  Contact1: Component$V,
  Contact2: Component$U,
  Contact3: Component$T,
  Content1: Component$S,
  Content2: Component$R,
  Content3: Component$Q,
  Content4: Component$P,
  Content5: Component$O,
  Content6: Component$N,
  Content7: Component$M,
  Content8: Component$L,
  Cta1: Component$K,
  Cta2: Component$J,
  Cta3: Component$I,
  Cta4: Component$H,
  Ecommerce1: Component$G,
  Ecommerce2: Component$F,
  Ecommerce3: Component$E,
  Features1: Component$D,
  Features2: Component$C,
  Features3: Component$B,
  Features4: Component$A,
  Features5: Component$z,
  Features6: Component$y,
  Features7: Component$x,
  Features8: Component$w,
  Footer1: Component$v,
  Footer2: Component$u,
  Footer3: Component$t,
  Footer4: Component$s,
  Footer5: Component$r,
  Gallery1: Component$q,
  Gallery2: Component$p,
  Gallery3: Component$o,
  Header1: Component$n,
  Header2: Component$m,
  Header3: Component$l,
  Header4: Component$k,
  ...
  Hero5: Component$f,
  Hero6: Component$e,
  Pricing1: Component$d,
  Pricing2: Component$c,
  Statistic1: Component$b,
  Statistic2: Component$a,
  Statistic3: Component$9,
  Step1: Component$8,
  Step2: Component$7,
  Step3: Component$6,
  Team1: Component$5,
  Team2: Component$4,
  Team3: Component$3,
  Testimonial1: Component$2,
  Testimonial2: Component$1,
  Testimonial3: Component
};
