        ...
        <div className="surface-0 flex justify-content-center">
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center" passHref>
                        <Image src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'}.svg`} alt="Sakai Logo" height={50} width={80} className="mr-0 lg:mr-2" />
                ...
                >
                    ...
                    <div className="flex justify-content-center md:justify-content-end">
                        <Image src="/demo/images/landing/screen-1.png" alt="Hero Image" className="w-9 md:w-auto" width={80} height={30} />
                    </div>
                </div>
                    ...
                    <div className="grid justify-content-center">
                        ...
                        >
                            <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                                ...
                                <Image src="/demo/images/landing/peak-logo.svg" className="mt-4" alt="Company logo" height={30} width={80} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    ...
                    <div className="grid mt-8 pb-2 md:pb-8">
                        <div className="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style={{ borderRadius: '8px' }}>
                            <Image src="/demo/images/landing/mockup.svg" className="w-11" alt="mockup mobile" width={44} height={30} />
                        </div>
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        ...
                        <div className="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style={{ borderRadius: '8px' }}>
                            <Image src="/demo/images/landing/mockup-desktop.svg" className="w-11" alt="mockup" width={44} height={30} />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid justify-content-between mt-8 md:mt-0">
                        <div className="col-12 lg:col-4 p-0 md:p-3">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <Image src="/demo/images/landing/free.svg" className="w-10 h-10 mx-auto" alt="free" width={40} height={40} />
                        ...
                        <div className="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <Image src="/demo/images/landing/startup.svg" className="w-10 h-10 mx-auto" alt="startup" width={40} height={30} />
                                <div className="my-5 text-center">
                        ...
                        <div className="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <Image src="/demo/images/landing/enterprise.svg" className="w-10 h-10 mx-auto" alt="enterprise" width={40} height={40} />
                                <div className="my-5 text-center">
                ...
                <div className="py-4 px-4 mx-0 mt-8 lg:mx-8">
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <Link href="/" className="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer" passHref>
                                <Image src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'}.svg`} alt="footer sections" width={50} height={50} className="mr-2" />
                            ...
                            <div className="grid text-center md:text-left">
                                ...
                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    ...
                                    <a className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                                        Events
                                        <Image src="/demo/images/landing/new-badge.svg" className="ml-2" alt="badge" width={80} height={30} />
                                    </a>
