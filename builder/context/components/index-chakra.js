...
<AppFooter>
`
const blackSource1=`<heading1 size="h1">Enter Text here</heading1>`
...
const blockSource2=`<Button width="200px" height="30px" color="#FFFFFF" background="#008000" borderRadius="0px">Button</Button>`
...
const blockSource3=`<Container width="100%" height="400px" border="1px solid black"><div class="text-black text-base"></div></Container>`
