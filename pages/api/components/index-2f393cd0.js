...
<section class="bg-gray-900 text-white">
  ...
  >
    <div class="mx-auto max-w-3xl text-center">
      <h1
        class="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl caret-white"
      >
        Understand User Flow.
        <br/>
        Increase Conversion.
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        <a
          class="block w-full rounded border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto cursor-pointer"
          href="/get-started"
        >
          Get Started
        </a>
        ...
        <a
          class="block w-full rounded border border-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto cursor-pointer"
          href="/about"
        >
          Learn More
        </a>
...
<div class=" flex flex-row justify-center">
  <div class="w-96 mt-16 pl-10">
    <p class=" font-normal text-3xl text-[#000000] inline">Develop A </p>
    <span class="font-normal text-3xl text-pink-600 inline">Workforce That Delivers on </span>
    <span class="font-normal text-3xl text-[#000000] inline">Key Initiatives</span>
    <p class="w-96 mt-3">
        Empower your tech teams to produce key business outcomes by upskilling and reskilling them to drive digital transformation. Upskill your workforce to deliver business results and stay competitive. Reduce ramp time for new hires and existing staff by giving them a training environment customized to your tech stack to quickly build deep expertise.
    </p>
  </div>
...
const source$$ = `
<aside
  class="overflow-hidden bg-gray-900 sm:grid sm:grid-cols-2"
>
...
const source$Z = `
<aside
  class="overflow-hidden bg-gray-900 sm:grid sm:grid-cols-2 sm:items-center"
>
  <div class="p-8 md:p-12 lg:px-16 lg:py-24">
    <div class="mx-auto max-w-xl text-center sm:text-left">
      <h2 class="text-2xl font-bold text-white md:text-3xl">
      ...
      <div class="mt-4 md:mt-8">
        <a
          href="#"
          class="inline-block rounded bg-red-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-red-700 focus:outline-none focus:ring focus:ring-yellow-400 cursor-pointer"
        >
          Get Started Today
        </a>
      </div>
  ...
  <div class="p-8 md:p-12 lg:px-16 lg:py-24">
    <div class="mx-auto max-w-xl text-center sm:text-left">
      ...
      <div class="mt-4 md:mt-8">
        <button
          href="#"
          class="inline-block rounded bg-red-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-red-700 focus:outline-none focus:ring focus:ring-yellow-400"
        >
          Get Started Today
        </button>
      </div>
...
<aside>
  <div class="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      <div class="bg-blue-600 p-8 md:order-last md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl text-center">
          <h2 class="text-2xl font-bold text-white md:text-3xl">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit
          </h2>
...
<footer class="bg-gray-50">
  <div class="mx-auto max-w-screen-xl space-y-12 px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div
      class="grid grid-cols-1 gap-8 border-t border-gray-100 pt-12 sm:grid-cols-2 lg:grid-cols-4"
    >
      <div>
    ...
    <p class="text-xs text-gray-500">\xA9 2022 Company Name</p>
  </div>
</footer>
`;
  ...
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
    ...
    <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div class="mx-auto max-w-sm lg:max-w-none">
        <p
          class="mt-4 text-center text-gray-400 lg:text-left lg:text-lg"
        >
    ...
    <div class="mt-16 border-t pt-8 border-gray-800">
      ...
      >
        \xA9 Company 2022. All rights reserved.
...
<footer class="bg-gray-900">
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p
      class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-400"
    >
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
      consequuntur amet culpa cum itaque neque.
    </p>
...
<footer class="bg-gray-100">
  ...
  >
    ...
    <p class="mt-12 text-center text-sm text-gray-500 lg:text-right">
      Copyright \xA9 2022. All rights reserved.
    </p>
  </div>
</footer>
...
<footer class="bg-gray-900">
  ...
  >
    ...
    <div class="lg:flex lg:items-end lg:justify-between">
      <div>
        <div
          class="flex justify-center text-blue-300 lg:justify-start"
        >
          <svg
            class="h-8"
            viewBox="0 0 118 24"
      ...
      >
        ...
        <div class="text-center sm:text-left">
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              <a
                class="flex items-center justify-center gap-1.5 sm:justify-start cursor-pointer"
                href="/"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="mt-12 border-t border-gray-100 pt-6">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-500">
          ...
          <a
            class="inline-block text-blue-600 underline transition hover:text-blue-600/75 cursor-pointer"
            href="/"
          >
            Terms & Conditions
          </a>
...
<footer class="bg-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div
          class="flex justify-center text-blue-300 sm:justify-start"
        >
          <svg
            class="h-8"
            viewBox="0 0 118 24"
          ...
          <ul class="mt-8 space-y-4 text-sm">
            ...
            <li>
              ...
              >
                ...
                <span class="text-gray-300">0123456789</span>
              </a>
            </li>
            ...
            >
              ...
              <address
                class="-mt-0.5 not-italic text-gray-300"
              >
                213 Lane, London, United Kingdom
              </address>
            </li>
    ...
    <div class="mt-12 border-t pt-6 border-gray-800">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-400">
          <span class="block sm:inline">All rights reserved.</span>

          <a
            class="inline-block underline transition text-blue-500 hover:text-blue-500/75 cursor-pointer"
            href="/"
          >
            Terms & Conditions
          </a>
        ...
        <p
          class="mt-4 text-sm text-gray-400 sm:order-first sm:mt-0"
        >
          \xA9 2022 Company Name
        </p>
      </div>
...
<footer class="bg-white">
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-center lg:justify-between">
      ...
      <p
        class="mx-auto mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:ml-0 sm:text-left lg:mr-0 lg:mt-0"
      >
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
        consequuntur amet culpa cum itaque neque.
      </p>
...
<footer class="bg-gray-50">
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p class="mt-8 text-xs text-gray-500">\xA9 2022 Company Name</p>
  </div>
</footer>
`;
...
<footer class="bg-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-center lg:justify-between">
      ...
      <p
        class="mx-auto mt-4 max-w-md text-center leading-relaxed text-gray-400 sm:ml-0 sm:text-left lg:mr-0 lg:mt-0"
      >
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
        consequuntur amet culpa cum itaque neque.
      </p>
    ...
    <div
      class="mt-16 grid grid-cols-1 gap-8 border-t pt-16 border-gray-800 md:grid-cols-4 lg:grid-cols-6"
    >
      <div class="text-center sm:text-left">
        <p class="text-lg font-medium text-white">
          About Us
        ...
        <nav class="mt-8">
          <ul class="space-y-4 text-sm">
            ...
            <li>
              ...
              >
                <span
                  class="transition group-text-white group-hover:text-white/75"
                >
                  Live Chat
                </span>
      ...
      <div class="text-center sm:text-left md:col-span-4 lg:col-span-2">
        ...
        <div class="mx-auto mt-8 max-w-md sm:ml-0">
          <p
            class="text-center leading-relaxed text-gray-400 sm:text-left"
          >
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum id,
            iure consectetur et error hic!
          </p>
          ...
          <form class="mt-4">
            ...
            >
              ...
              <input
                class="w-full rounded-full px-6 py-3 shadow-sm border-gray-700 bg-gray-800 text-white"
                type="email"
                placeholder="Enter your email"
              />
    ...
    <div
      class="mt-16 border-t pt-6 border-gray-800 sm:flex sm:items-center sm:justify-between"
    >
      <p
...
<footer class="bg-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div class="mt-16">
      ...
      <div class="mt-16 sm:flex sm:items-center sm:justify-between">
        <div
          class="flex justify-center text-blue-600 text-blue-300 sm:justify-start"
        >
          <svg
            class="h-8"
            viewBox="0 0 118 24"
        ...
        <p
          class="mt-4 text-center text-sm text-gray-400 sm:mt-0 sm:text-right"
        >
          Copyright \xA9 2022. All rights reserved.
        </p>
      </div>
    ...
    <div class="mt-12 border-t border-white/10 pt-8">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <p class="text-center text-xs text-gray-400 lg:text-left">
          Copyright \xA9 2022. Company Name. All rights reserved.
        </p>
...
>
  <div class="mx-auto max-w-screen-xl px-4 pt-32 pb-12 sm:px-6 lg:px-8">
    ...
    <div
      class="mt-32 border-t border-white/25 pt-12 sm:flex sm:items-center sm:justify-between"
    >
      <nav
...
const source$A = `
<footer class="bg-gray-900 text-white lg:grid lg:grid-cols-5">
  ...
  <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    ...
    <div class="mt-12 border-t border-gray-800 pt-12">
      ...
      >
        ...
        <p class="mt-4 sm:mt-0">\xA9 2022 Company Name.</p>
      </div>
...
<footer class="bg-white text-center">
  <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-3xl space-y-6">
      ...
      <nav class="rounded-3xl border-4 border-gray-900 p-6">
      ...
      <p class="mx-auto max-w-lg text-xs text-gray-500">
        ...
        <span class="mt-4 block"> \xA9 2022 Saul Goodman </span>
      </p>
    </div>
  </div>
</footer>
...
<footer class="text-center bg-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-3xl space-y-6">
      ...
      <nav
        class="rounded-3xl border-4 p-6 border-gray-700"
      >
        <ul class="flex flex-wrap justify-center gap-6 text-sm font-bold">
          <li>
            <a
      ...
      >
        ...
        <div class="mt-12 space-y-4 lg:mt-0">
          ...
          <div class="text-center lg:text-left">
            ...
            <p
              class="mx-auto mt-4 max-w-md text-sm leading-relaxed text-gray-400 lg:mx-0"
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
      ...
      <div class="pt-16 pb-8 lg:pt-24 lg:pr-12">
            ...
            <nav class="mt-4">
              <ul class="space-y-1.5 text-sm">
                ...
                <li>
                  ...
                  >
                    <span
                      class="text-white transition group-hover:text-white/75"
                    >
                      Live Chat
                    </span>
        ...
        >
          ...
          <p class="mt-4 text-center lg:text-left">
            \xA9 2022 Company Name. All rights reserved.
          </p>
        </div>
      </div>
    </div>
...
<header class="bg-white">
  ...
  >
    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      <nav class="hidden md:block" aria-label ledby="header-navigation">
        <h2 class="sr-only" id="header-navigation">Header navigation</h2>

        <ul class="flex items-center gap-6 text-sm">
          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75 cursor-pointer" href="/">
              About
            </a>
          </li>
      ...
      <div class="flex items-center gap-4">
        <div class="sm:flex sm:gap-4">
          <a
            class="block rounded-md bg-blue-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700 cursor-pointer"
            href="/"
          >
            Login
          </a>
          ...
          <a
            class="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-blue-600 transition hover:text-blue-600/75 sm:block cursor-pointer"
            href="/"
          >
            Register
          </a>
        ...
        <button
          class="block rounded bg-gray-100 p-2.5 text-gray-600 transition hover:text-gray-600/75 md:hidden cursor-pointer"
        >
...
<nav class="mx-auto flex max-w-3xl items-center justify-between p-4">
  <a
    class="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100 cursor-pointer"
    href="/"
  >
    \u{1F44B}
  </a>
  ...
  <ul class="flex items-center gap-2 text-sm font-medium text-gray-500">
    <li class="hidden lg:block">
      <a class="rounded-lg px-3 py-2 cursor-pointer" href="/"> Home </a>
    </li>

    <li><a class="rounded-lg px-3 py-2 cursor-pointer" href=""> Projects </a></li>

    <li>
      <a
        class="inline-flex items-center rounded-lg px-3 py-2 cursor-pointer"
        href=""
        target="_blank"
      >
        External
    ...
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <div class="sm:flex sm:gap-4">
            <a
              class="block rounded-md bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow cursor-pointer"
              href="/"
            >
              Login
            </a>
            ...
            <div class="hidden sm:flex">
              <a
                class="block rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-blue-600 cursor-pointer"
                href="/"
              >
                Register
              </a>
          ...
          <div class="block md:hidden">
            <button
              class="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75 cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
    ...
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <div class="sm:flex sm:gap-4">
            <a
              class="block rounded-md bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow hover:bg-blue-500 cursor-pointer"
              href="/"
            >
              Login
            </a>
            ...
            <div class="hidden sm:flex">
              <a
                class="block rounded-md px-5 py-2.5 text-sm font-medium bg-gray-800 text-white hover:text-white/75 cursor-pointer"
                href="/"
              >
                Register
              </a>
          ...
          <div class="block md:hidden">
            <button
              class="rounded p-2 transition bg-gray-800 text-white hover:text-white/75 cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
...
<header class=" bg-blue-700">
  <div class="mx-auto max-w-screen-xl px-4 ">
    <div class="flex h-16 items-center justify-between">
      <div class="flex-1 md:flex md:items-center md:gap-12">
        <a class="block text-blue-300 w-20 h-1 pr-2 cursor-pointer" href="/">
          <svg width="208" class=" " height="24" viewBox="0 0 208 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M39.3255 0C39.7406 0.0788722 40.161 0.147676 40.5744 0.236617C42.1289 0.580049 43.539 1.3739 44.6176 2.51282C45.6961 3.65174 46.3922 5.0819 46.6135 6.61352C47.193 10.7887 44.3646 14.5947 40.1108 15.266C39.0003 15.4619 37.8588 15.4179 36.7678 15.1372C35.6767 14.8564 34.6629 14.3457 33.7985 13.6415C33.5442 13.4418 33.4023 13.4553 33.193 13.6701C32.8297 14.0409 32.4544 14.4034 32.0634 14.7474C32.019 14.7762 31.9808 14.8131 31.9511 14.8562C31.9215 14.8992 31.9008 14.9476 31.8904 14.9984C31.8799 15.0492 31.8799 15.1015 31.8903 15.1523C31.9007 15.2031 31.9213 15.2514 31.951 15.2945C32.3156 16.053 32.5098 16.878 32.5205 17.7149C32.5313 18.5517 32.3584 19.3812 32.0134 20.1483C31.6683 20.9154 31.159 21.6025 30.5192 22.1639C29.8794 22.7254 29.1239 23.1484 28.3026 23.4049C24.7598 24.5393 20.897 22.2218 20.3936 18.6642C20.2602 17.7544 20.3449 16.8269 20.641 15.954C20.6642 15.9137 20.6781 15.8689 20.6818 15.8229C20.6856 15.7769 20.679 15.7306 20.6626 15.6872C20.6461 15.6439 20.6202 15.6045 20.5867 15.5717C20.5531 15.539 20.5126 15.5137 20.468 15.4975C19.7103 15.0797 18.963 14.6451 18.2486 14.2389C17.8171 14.5891 17.3654 14.9152 16.8958 15.2156C15.9838 15.7372 14.9175 15.9462 13.8683 15.8089C12.8191 15.6716 11.848 15.1961 11.111 14.4588C10.8343 14.1836 10.6561 14.1634 10.3637 14.4101C10.0387 14.671 9.69727 14.912 9.34138 15.1317C9.25762 15.1766 9.19376 15.2498 9.16188 15.3373C9.13 15.4248 9.13231 15.5206 9.16839 15.6066C9.54031 17.0733 8.60618 18.4108 7.0562 18.5618C6.74401 18.5944 6.42825 18.5662 6.12745 18.4789C5.82665 18.3915 5.54687 18.2467 5.30452 18.0531C5.06217 17.8594 4.86214 17.
<path d="M157.248 18.1976H165.817V20.151H154.746V1.88281H165.378V3.80092H164.902C162.493 3.80092 160.081 3.80092 157.671 3.79253C157.313 3.79253 157.215 3.89489 157.218 4.23723C157.235 5.91536 157.232 7.57671 157.218 9.24813C157.218 9.54348 157.305 9.63243 157.613 9.63075C159.899 9.62068 162.186 9.63075 164.473 9.63075H164.933V11.5421C164.786 11.5421 164.643 11.564 164.497 11.564C162.211 11.564 159.925 11.564 157.637 11.564C157.318 11.564 157.215 11.6411 157.216 11.9617C157.23 13.9167 157.216 15.8734 157.216 17.8351C157.216 17.9409 157.228 18.0466 157.239 18.2094" fill="white"/>
</svg>
      ...
      <div class="md:flex md:items-center md:gap-12">
        <nav class="hidden md:block" aria-labelledby="header-navigation">
          ...
          <ul class="flex items-center gap-6 text-sm">
            <li class=" inline-flex items-center gap-1">
              ...
              <svg width="11" class="w-3 h-2" height="5" viewBox="0 0 11 5" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.38281 5L0.382812 0H10.3828L5.38281 5Z" fill="white"/>
              </svg>
            ...
            <li class=" inline-flex items-center gap-1">
              ...
              <svg class="w-3 h-2" width="11" height="5" viewBox="0 0 11 5" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.38281 5L0.382812 0H10.3828L5.38281 5Z" fill="white"/>
              </svg>
        ...
        <div class="flex items-center gap-4">
          <div class="sm:flex sm:gap-4">
            <a
              class="block rounded-md bg-white px-5 py-2.5 text-sm font-mediu text-blue-700 shadow hover:bg-blue-500 cursor-pointer"
              href="/"
            >
              Watch Demo
            </a>
  ...
  <div>
  <svg width="1326" height="1" viewBox="0 0 1326 1" fill="none" xmlns="http://www.w3.org/2000/svg">
  <line y1="0.5" x2="1326" y2="0.5" stroke="#D9D9D9"/>
  </svg>
  </div>
</header>
`;
  ...
  <div class="max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    >
      <div class="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
        ...
        <a
          class="mt-8 inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 cursor-pointer"
          href="/get-started"
        >
    ...
    <div class="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
      ...
      <div class="relative flex items-center bg-gray-100">
        ...
        <div class="p-8 sm:p-16 lg:p-24">
          ...
          <a
            href="#"
            class="mt-8 inline-block rounded border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 cursor-pointer"
          >
            Get in Touch
          </a>
        </div>
...
<section class="bg-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
    ...
    <div class="mt-8 sm:mt-12">
      <dl class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div
          class="flex flex-col rounded-lg border px-4 py-8 text-center border-gray-800"
        >
          <dt
            class="order-last text-lg font-medium text-gray-400"
          >
            Total Sales
          </dt>
        ...
        <div
          class="flex flex-col rounded-lg border border-gray-100 px-4 py-8 border-gray-800"
        >
          <dt
            class="order-last text-lg font-medium text-gray-400"
          >
  ...
  >
    <div class="max-w-7xl items-end justify-between sm:flex sm:pr-6 lg:pr-8">
      ...
      <div class="mt-8 flex lg:mt-0">
        <button
          class="prev-button rounded-full border border-current p-3 text-pink-600 transition-colors focus:bg-pink-600 focus:text-white focus:outline-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5 -rotate-180 transform"
        ...
        <button
          class="next-button ml-3 rounded-full border border-current p-3 text-pink-600 focus:bg-pink-600 focus:text-white focus:outline-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      >
        <div class=" border-slate-700" style={{border:"1px solid gray"}}>
          ...
          <blockquote
            class="-mt-6 flex flex-col justify-between rounded-lg pt-12 pl-3 pr-3 text-center shadow-xl"
          >
          <div class=" flex pl-3">
            ...
            <p class="text-lg font-bold text-gray-700">5 Things Recruiters can focus on during a tech hiring freeze</p>
            <p class="mt-4 text-sm text-gray-500">
            Technology plays a crucial role in almost every industry in today’s rapidly evolving business landscape...
            </p>

            <div class="mt-8  gap-0.5 text-black">
            <svg class=" bg-gray-600" width="366" height="2" viewBox="0 0 366 2" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect opacity="0.4" width="366" height="2" fill="#1D1D1D" fill-opacity="0.2"/>
            </svg>
            <div class="flex mt-1">
              <p>May 05, 2023</p>
              <p>by John Doe Kumar</p>
            </div>
            </div>
          </blockquote>
        </div>
...
const Component$13 = {
  source: source$13,
  displayName: "Testimonials 9",
  category: "Testimonials"
};


const components = {
  Banner1: Component$12,
  Banner2: Component$11,
  Banner3: Component$10,
  Banner4:Component$15,
  Cta1: Component$$,
  Cta2: Component$_,
  Cta3: Component$Z,
  Cta4: Component$Y,
  ...
  Faq4: Component$S,
  Footer1: Component$R,
  Footer10: Component$Q,
  Footer11: Component$P,
  Footer12: Component$O,
  Footer13: Component$N,
  Footer14: Component$M,
  Footer15: Component$L,
  Footer16: Component$K,
  Footer17: Component$J,
  Footer18: Component$I,
  Footer19: Component$H,
  Footer2: Component$G,
  Footer20: Component$F,
  Footer21: Component$E,
  Footer22: Component$D,
  Footer23: Component$C,
  Footer3: Component$B,
  Footer4: Component$A,
  Footer5: Component$z,
  Footer6: Component$y,
  ...
  Form3: Component$s,
  Form4: Component$r,
  Navigation1: Component$q,
  Navigation10: Component$p,
  Navigation2: Component$o,
  Navigation3: Component$n,
  Navigation4: Component$m,
  Navigation5: Component$l,
  Navigation6: Component$k,
  Navigation7: Component$j,
  Navigation8: Component$i,
  Navigation9: Component$h,
  Navigation11:Component$16,
  Review1: Component$g,
  Section1: Component$f,
  Section2: Component$e,
  Section3: Component$d,
  Section4: Component$c,
  Section5: Component$b,
  Section6: Component$a,
  Stats1: Component$9,
  Stats2: Component$8,
  Testimonials1: Component$7,
  Testimonials2: Component$6,
  Testimonials3: Component$5,
  Testimonials4: Component$4,
  Testimonials5: Component$3,
  Testimonials6: Component$2,
  Testimonials7: Component$1,
  Testimonials8: Component,
  Testimonials9: Component$13
};
