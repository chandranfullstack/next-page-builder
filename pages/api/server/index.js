...
var util$2 = require$$0__default["default"],
    fs$1 = fs__default["default"],
    EventEmitter$2 = require$$2__default["default"].EventEmitter,
    crypto$1 = require$$3__default["default"];

function File$1(properties) {
  ...
  if(typeof this.hash === 'string') {
    this.hash = crypto$1.createHash(properties.hash);
  } else {
    this.hash = null;
  }
}
var file = File$1;
util$2.inherits(File$1, EventEmitter$2);

File$1.prototype.open = function() {
  this._writeStream = new fs$1.WriteStream(this.path);
};

File$1.prototype.toJSON = function() {
  var json = {
    size: this.size,
    path: this.path,
    name: this.name,
...
File$1.prototype.write = function(buffer, cb) {
  var self = this;
  if (self.hash) {
...
File$1.prototype.end = function(cb) {
  var self = this;
  if (self.hash) {
...
var querystring = require$$0__default$2["default"];

function QuerystringParser$1(maxKeys) {
  this.maxKeys = maxKeys;
  this.buffer = '';
}
querystring_parser.QuerystringParser = QuerystringParser$1;
...
var EventEmitter$1 = require$$2__default["default"].EventEmitter
	, util$1 = require$$0__default["default"];

function OctetParser$1(options){
	if(!(this instanceof OctetParser$1)) return new OctetParser$1();
	EventEmitter$1.call(this);
}

util$1.inherits(OctetParser$1, EventEmitter$1);

octet_parser.OctetParser = OctetParser$1;
...
json_parser.JSONParser = JSONParser$1;
...
var util = require$$0__default["default"],
    ...
    StringDecoder = require$$9__default["default"].StringDecoder,
    EventEmitter = require$$2__default["default"].EventEmitter,
    Stream = require$$11__default["default"].Stream,
    os = require$$12__default["default"];
...
const loadDynamicData = async (params) => {
	...
	const basePath = pathModule.join(__dirname, dataFolder);
