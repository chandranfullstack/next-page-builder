...
const OverlayDemo = () => {
    ...
    const imageBodyTemplate = (data) => <Image src={`/demo/images/product/${data.image}`} alt={data.image} className="product-image" width={60} height={30} style={{ boxShadow: '0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23)' }} />;
                        ...
                        <div className="flex flex-wrap gap-2">
                            <div>
                                ...
                                <OverlayPanel ref={op} appendTo={typeof window !== 'undefined' ? document.body : null} showCloseIcon>
                                    <Image src="/demo/images/nature/nature9.jpg" alt="nature1" height={30} width={80} />
                                </OverlayPanel>
                            </div>
                            <div>
